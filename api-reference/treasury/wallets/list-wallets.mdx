---
title: "List wallets"
description: "List all wallets in a treasury account."
api: "GET /mpc/accounts/{accountId}/wallets/list"
---
...
```bash cURL
curl -X GET "https://api.cryptomate.me/mpc/accounts/acc_6f1e2a30-4a3c-4b2e-9a1d-5e8c9b7a1f23/wallets/list" \
