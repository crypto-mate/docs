...
Searches and retrieves transactions for a specific individual card with filtering, pagination, and sorting. Requires an API key with access level 1 or higher.
