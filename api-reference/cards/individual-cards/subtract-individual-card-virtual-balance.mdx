---
title: "Subtract from individual card virtual balance"
description: "Subtract a delta amount from the virtual balance of an individual card."
api: "POST /cards/individual-cards/{cardId}/virtual-balance/subtract"
---

Subtracts a delta amount from the virtual balance of an individual card, and returns the resulting balance in USD. Unlike [Override individual card virtual balance](/api-reference/cards/individual-cards/override-individual-card-virtual-balance), which sets an absolute value, this endpoint applies a relative change.
...
```bash cURL
curl -X POST "https://api.cryptomate.me/cards/individual-cards/card_6f1e2a30-4a3c-4b2e-9a1d-5e8c9b7a1f23/virtual-balance/subtract" \
