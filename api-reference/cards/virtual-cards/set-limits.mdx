...
<ParamField body="daily_limit" type="number">
  Daily spending limit in USD. Must be zero or greater.
</ParamField>

<ParamField body="weekly_limit" type="number">
  Weekly spending limit in USD. Must be zero or greater.
</ParamField>

<ParamField body="monthly_limit" type="number">
  Monthly spending limit in USD. Must be zero or greater.
</ParamField>
