...
<ParamField header="X-API-Version" type="string" required>
  Must be `2`. Any other value — including omitting the header — serves [version 1](/api-reference/cards/transactions/search-transactions), which reports one item per event.
</ParamField>
