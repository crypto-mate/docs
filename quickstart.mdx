...
Sign up on the [CryptoMate Portal](https://portal.cryptomate.me) and complete the onboarding for your organization. Once you're in, you'll have access to both environments:
...
From the Portal, open the **API Keys** section and create a new key.
...
Most production integrations need to react to events asynchronously (a deposit arrives, a card transaction is authorized, a withdrawal completes). Expose an HTTPS endpoint and register it from the Portal to start receiving events.
