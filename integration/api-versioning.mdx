...
Endpoints that support version 2 today:

- [Search card transactions](/api-reference/cards/transactions/search-transactions)
- [Get transaction](/api-reference/cards/transactions/get-transaction)
