...
Mirror addresses accept **USDC only**, and the **10 USD minimum deposit** applies to them as well. A smaller deposit is neither transferred nor credited: the funds stay at the mirror address and cannot be recovered through the platform.
</Warning>
